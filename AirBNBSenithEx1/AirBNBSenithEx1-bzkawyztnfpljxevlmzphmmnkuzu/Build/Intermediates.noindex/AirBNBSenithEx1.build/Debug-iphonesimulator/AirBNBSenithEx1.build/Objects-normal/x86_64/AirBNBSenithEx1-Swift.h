...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AirBNBSenithEx1",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15AirBNBSenithEx111AppDelegate")
...
@class UpdatedTextFiled;
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC15AirBNBSenithEx122PasswordViewController")
@interface PasswordViewController : UIViewController
@property (nonatomic, weak) IBOutlet UpdatedTextFiled * _Null_unspecified Ps;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC15AirBNBSenithEx111RoundButton")
...
SWIFT_CLASS("_TtC15AirBNBSenithEx113SceneDelegate")
...
SWIFT_CLASS("_TtC15AirBNBSenithEx113UpdatedButton")
@interface UpdatedButton : UIButton
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15AirBNBSenithEx116UpdatedTextFiled")
@interface UpdatedTextFiled : UITextField
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15AirBNBSenithEx114ViewController")
